<template>
     ...
     <transition name='anime' enter-active-class='animated fadeIn' :duration='200' leave-active-class='animated fadeOut'>
       ...
       <td><router-link to="/projects">
        <v-img :src="'http://localhost:8000/storage/project/'+con.image" class="img-thumbnail img-responsive size" :alt="con.title"
    ...
    return {
      ...
      meta:[
          ...
          { hid: 'description8', name: 'description', content: "Henry Onyemaobi's, a web developer's portfolio website" },
    ...
    axios.post('http://localhost:8000/api/save-project',formdata).then(res=>{
      if(res.data == 1){
       ...
       blogcount(){
           ...
           //  alert("Subscription count failed...");
            ...
            fetch(page_url){
              ...
              var   page_url = page_url || 'http://localhost:8000/project-content';
              ...
              .catch(error =>{
             alert("Project data failed...Please reload page");
                this.$nuxt.$loading.finish()        
                  })
            },
    ...
    //send to database with axios
    axios.post('http://localhost:8000/api/update',formdata).then(res=>{
                if(res.data == 1){
    ...
    removeProj(id){
      ...
      axios.post('http://localhost:8000/api/destroy',input)
      .then(res=>{
        if(res.data == 1){
